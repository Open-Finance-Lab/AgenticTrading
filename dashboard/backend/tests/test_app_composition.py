...
EXPECTED_FULL_CONTRACT = {
    ...
    ("POST", "/api/v1/leaderboard/live/refresh"),
    ...
    ("GET", "/api/v1/research/agents/{template_id}/manifest"),
    ("POST", "/api/v1/research/agents/{template_id}/add"),
    ("DELETE", "/api/v1/research/agents/{template_id}/add"),
    ("POST", "/api/v1/research/agents/{template_id}/runs"),
    ("GET", "/api/v1/research/runs"),
    ("GET", "/api/v1/research/runs/{run_id}"),
    ("GET", "/api/v1/research/runs/{run_id}/report"),
    ("GET", "/api/v1/research/runs/{run_id}/artifacts/{kind}"),
    ("GET", "/admin-analytics"),
    ("GET", "/styles.css"),
    ("GET", "/ticker"),
}
