...
window of its own, so the scan is the wider of the two. Derived rather than
written down so that adding a longer movement range cannot silently widen every
user's scan.
"""
